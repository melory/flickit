...
#define CELLNUM 1533 //cell id: 0~1532
...
main()
{
	int i, j, k, tagid, tagnum, freq, cellid_actual, tag_cell, tag_globe = 0, a_tag_total, **frequency, tag_seq[1000];
	char name[30], id[11];
	double lat, lon, PTL;
	FILE *fp_input, *fp_freq, *fp_PTL;
